# **[IMPORTANT NOTICE: Distinction from CVE-2025-10963 and Patch Bypass Explanation]**

This submission is **NOT a duplicate** of the previously disclosed CVE-2025-10963. Instead, it documents a clear **Patch Bypass (Incomplete Fix)** in the vendor's latest firmware.

In the older firmware (V240425) associated with CVE-2025-10963, the `del_flag` parameter was concatenated into system commands without effective sanitization. In the newer firmware tested in this report (V251208), the vendor attempted to patch CVE-2025-10963 by **introducing a brand-new input filter function (`sub_405B2C`)**.
